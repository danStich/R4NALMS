...
All data and code files needed for both sessions are located <a href="https://github.com/danStich/R4NALMS"> here </a>. You can download the workshop content as a compressed (ZIP) folder by clicking on the green "code" button and choosing "Download ZIP" in the drop down menu that. The screenshot below demonstrates this.
